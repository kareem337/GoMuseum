...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_file', type=str, default='C:/Users/hp/OneDrive/Desktop/outpainting_srn-master/imgs/celebahq-256/1.png', help='the file storing training file paths')
